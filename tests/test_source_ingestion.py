...
def build_test_settings(workspace: Path) -> Settings:
    ...
    return Settings(
        ...
        snowflake_stage="REVIEWPULSE_S3_STAGE",
        snowflake_file_format="REVIEWPULSE_PARQUET_FORMAT",
        snowflake_normalized_table="NORMALIZED_REVIEWS",
        snowflake_sentiment_table="REVIEWS_WITH_SENTIMENT",
        snowflake_truncate_before_load=True,
        spark_master="local[*]",
